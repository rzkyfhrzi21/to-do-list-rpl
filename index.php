...
$query = "SELECT * FROM pengguna WHERE id_pengguna = '$sesi_id'";

if ($sql = mysqli_query($koneksi, $query)) {
    // Ambil data pengguna
    $pengguna      = mysqli_fetch_array($sql);
    $sesi_nama  = isset($pengguna['nama']) ? $pengguna['nama'] : '';
    $sesi_penggunaname = isset($pengguna['username']) ? $pengguna['username'] : '';
}

// Pastikan pengguna sudah login dan memiliki role admin
if (!isset($_SESSION['sesi_id']) || empty($pengguna)) {
    ...
    <div id="app">
        <div id="main" class="layout-horizontal">
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUser Dropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="user-dropdown-status text-sm text-muted"><?= $sesi_penggunaname; ?></p>
                                    </div>
                                </a>
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            ...
                            <li class="menu-item">
                                <a href="?page=hari_ini" class="menu-link">
                                    <span><i class="bi bi-calendar-check-fill"></i> Hari Ini</span>
                                </a>
                            </li>

                            <li class="menu-item">
                                <a href="?page=tugas" class="menu-link">
                                    <span><i class="bi bi-check2-square"></i> Tugas</span>
                                </a>
                            </li>

                            <li class="menu-item">
                                <a href="?page=statistik" class="menu-link">
                                    <span><i class="bi bi-bar-chart-fill"></i> Statistik</span>
                                </a>
                            </li>
            ...
            <div class="content-wrapper container">
                <?php require_once 'pages/status_pengingat.php'; ?>
                <?php
                ...
                switch ($page) {
                    ...
                    case 'hari_ini':
                        include 'pages/hari_ini.php';
                        break;

                    case 'tugas':
                        include 'pages/tugas.php'; // list + modal tambah/edit
                        break;
                    ...
                    <div class="footer clearfix mb-0 text-muted">
                        ...
                        <div class="float-end">
                            <p>Dibuat dengan <span class="text-danger"><i class="bi bi-heart"></i></span>
                                oleh <a href="<?= URL_WA ?>" target="_blank"><?= NAMA_LENGKAP ?></a></p>
                        </div>
                    </div>
                </div>
            </footer>
